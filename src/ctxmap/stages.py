"""Experiment stages for Predicting Answer Features Before the Model Speaks."""
...
from .ctxmap._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "Predicting Answer Features Before the Model Speaks", "claims_gated": True})
