...
This note situates **Predicting Answer Features Before the Model Speaks** against the mentor-linked literature for
[Predicting Answer Features Before the Model Speaks](https://github.com/alanasung/context-to-answer-maps).

## Positioning

Train maps from context activations to upcoming answer-feature probes.

The design hypothesis is: Train maps from context activations to upcoming answer-feature probes.
